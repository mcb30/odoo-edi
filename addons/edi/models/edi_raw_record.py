...
class EdiDocument(models.Model):
    ...
    raw_model_id = fields.Many2one(related="raw_ids.model_id", string="Record Model", readonly=True)
    raw_count = fields.Integer(string="Record Count", compute="_compute_raw_count")
    raw_index_content = fields.Text(
        related="input_ids.index_content", readonly=True, prefetch=False
    )
