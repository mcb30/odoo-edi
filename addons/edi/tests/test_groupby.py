...
class TestGroupby(common.SavepointCase):
            ...
            contact_vals = {
                ...
                "category_id": [
                    (
                        6,
                        0,
                        cls.category_even.ids
                        if contact_no_even
                        else cls.category_odd.ids,
                    )
                ],
            }
    ...
    def _setup_companies_and_contacts(cls):
        ...
        cls.company_a_contacts = cls.create_contacts_for_partner(
            cls.company_a, contact_count
        )
        cls.company_b_contacts = cls.create_contacts_for_partner(
            cls.company_b, contact_count
        )
        cls.company_c_contacts = cls.create_contacts_for_partner(
            cls.company_c, contact_count
        )
        cls.all_contacts = (
            cls.company_a_contacts | cls.company_b_contacts | cls.company_c_contacts
        )
