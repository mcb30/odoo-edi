...
class TestFailFast(EdiSaleCase):
    ...
    def test_does_not_remove_existing_partners_with_no_orders(self):
        ...
        self.assertEqual(sales_by_name["ORD05"].order_line.product_id, self.apple)
    ...
    def test_removes_order_if_creation_fails(self):
        ...
        self.assertEqual(sales_by_name["ORD03"].partner_id.name, "Carol")
        self.assertEqual(len(sales_by_name["ORD03"].order_line), 1)
        self.assertEqual(sales_by_name["ORD03"].order_line.product_id, self.cherry)
