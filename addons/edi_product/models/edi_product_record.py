...
class EdiDocument(models.Model):
    ...
    product_ids = fields.One2many("edi.product.record", "doc_id", string="Products")
    inactive_product_ids = fields.One2many(
        "edi.inactive.product.record", "doc_id", string="Inactive Products"
    )
