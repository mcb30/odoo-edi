...
class TestSap(EdiProductCase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.doc_type_sap = cls.env.ref(
            'edi_product.sap_document_type'
        )
    ...
    def test01_basic(self):
        ...
        self.assertEqual(products_by_barcode['5055365644456'].name,
                         "Enrobed Mango")
        self.assertEqual(products_by_barcode['5055365625424'].name,
    ...
    def test03_correction(self):
        ...
        self.assertEqual(doc2.product_sap_ids.product_id.name,
                         "Tasty Enrobed Mango")
