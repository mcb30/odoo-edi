...
class TestPickReport(EdiPickCase):
        ...
        cls.doc_type_pick_report = EdiDocumentType.create(
            {
                ...
                "rec_type_ids": [
                    (6, 0, [cls.rec_type_pick_report.id, cls.rec_type_move_report.id])
                ],
    ...
    def test02_dummy(self):
        ...
        self.assertEqual(move_reports.mapped("move_ids"), self.pick_in.move_lines)
        move_reports_by_product = {x.product_id.default_code: x for x in move_reports}
