...
class EdiDocument(models.Model):
    ...
    partner_tutorial_ids = fields.One2many(
        "edi.partner.tutorial.record", "doc_id", string="Partners"
    )
...
class EdiPartnerTutorialRecord(models.Model):
    ...
    email = fields.Char(string="Email", required=False, readonly=True, index=True)
