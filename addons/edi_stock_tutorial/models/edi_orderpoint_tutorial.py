...
class EdiDocument(models.Model):
    ...
    orderpoint_tutorial_ids = fields.One2many(
        "edi.orderpoint.tutorial.record", "doc_id", string="Minimum Inventory Rules"
    )
...
class EdiOrderpointTutorialRecord(models.Model):
    ...
    lead_weeks = fields.Integer(
        string="Lead Time", required=True, readonly=True, help="Lead Time (in weeks)"
    )
